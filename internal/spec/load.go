...
type attRow struct {
	...
	BlobSHA string
	// Skip is the recorded reason the corpus will never hold these bytes. Non-empty
	// only where a pull decided so, and it is what stops the reason being re-asked.
	Skip string
