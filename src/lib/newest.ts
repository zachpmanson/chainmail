 ...
 * what they said (see ThreadRow) — and it is also where the reading pane lands
 * when a thread opens, so both ends of a click read the same rule rather than
 ...
 * entries attached to a thread are its top-scoring ones, and a search's idea of
